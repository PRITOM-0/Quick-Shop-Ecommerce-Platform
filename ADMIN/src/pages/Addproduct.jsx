...
const AddProduct = () => {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      setMsg({ error: err.response?.data?.message || "An error occurred. Please try again.", success: "" });
      setFormData({ title: "", description: "", price: "", category: "", image: "", stock: "" });
    }
  };
  ...
  return (
    <div className="min-h-screen bg-gray-50 py-10 px-4">
      <div className="max-w-xl mx-auto">
        ...
        {/* Alerts */}
        {msg.error && (
          <div className="mb-4 flex items-center gap-2.5 bg-red-50 border border-red-100 text-red-600 text-sm font-medium px-4 py-3 rounded-xl">
        ...
        {msg.success && (
          <div className="mb-4 flex items-center gap-2.5 bg-green-50 border border-green-100 text-green-600 text-sm font-medium px-4 py-3 rounded-xl">
            <svg className="w-4 h-4 shrink-0" fill="none" viewBox="0 0 24 24" stroke="currentColor">
          ...
          <form onSubmit={handleSubmit} className="px-6 py-6">
            ...
            {formData.image && (
              <div className="mt-4 sm:col-span-2">
                <p className="text-xs font-medium text-gray-400 mb-1.5">Image Preview</p>
                <img
                  src={formData.image}
                  alt="preview"
